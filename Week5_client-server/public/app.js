...
// ดึงค่าจาก config.js (ต้องโหลด config.js ก่อนไฟล์นี้ใน index.html)
...
function updateServerStatus(isConnected) {
    ...
    if (isConnected) {
        ...
        text.textContent = 'เชื่อมต่อ server แล้ว';
    } else {
        indicator.textContent = '🔴';
        text.textContent = 'ไม่สามารถเชื่อมต่อ server ได้';
    }
}
